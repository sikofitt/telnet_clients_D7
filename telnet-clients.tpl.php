...
<table class="telnet-table-link-block">
  ...
  <?php if( $telnet_links['SyncTerm'] != '0' ):  ?>
    <tr>
      ...
      <td>
        <a href="http://syncterm.bbsdev.net/" target="_blank">SyncTERM</a> is available for *nix/osx/win32 and a bunch of other oses.
      </td>
    </tr>
  <?php endif; ?>
  <?php if( $telnet_links['Termix'] != '0' ): ?>
    <tr>
      ...
      <td>
        <a href="http://sourceforge.net/projects/termix/" target="_blank">Termix</a> is available for *nix
      </td>
    </tr>
  <?php endif; ?>
  <?php if( $telnet_links['mTelnet'] != '0' ): ?>
    <tr>
      ...
      <td>
        <a href="http://mt32.bbses.info/" target="_blank">mTelnet</a> is available for os2/win32.
      </td>
    </tr>
  <?php endif; ?>
  <?php if( $telnet_links['Qodem'] != '0' ): ?>
    <tr>
      ...
      <td>
        <a href="http://sourceforge.net/projects/qodem/" target="_blank">Qodem</a> is available for *nix/osx/win32.
      </td>
    </tr>
  <?php endif; ?>
